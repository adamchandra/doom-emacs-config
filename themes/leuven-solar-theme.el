...
(let* (
  ...
  (custom-theme-set-faces
   ...
   ;; Mode line faces.
   `(mode-line ((,class (  :family "Iosevka"  :box (:line-width 1 :color "#1A2F54") :foreground "#85CEEB" :background "#335EA8"))))
   `(mode-line-inactive ((,class (:family "Iosevka" :box (:line-width 1 :color "#4E4E4C") :foreground "#F0F0EF" :background "#9B9C97"))))
   ...
   `(mode-line-highlight ((,class (:foreground "yellow"))))
    ...
    ;; `(doom-modeline-spc-face   ((,class  )))
    ;; `(doom-modeline-vspc-face   ((,class  )))
    `(doom-modeline-buffer-path   ((,class (:foreground ,yellow-l)  )))
    `(doom-modeline-buffer-file   ((,class )))
    ;; `(doom-modeline-buffer-modified   ((,class  )))
    ;; `(doom-modeline-buffer-major-mode   ((,class  )))
    ;; `(doom-modeline-buffer-minor-mode   ((,class  )))
    ;; `(doom-modeline-project-parent-dir   ((,class  )))
    `(doom-modeline-project-dir   ((,class (:foreground ,yellow))  ))
    `(doom-modeline-project-root-dir   ((,class (:foreground ,yellow-d))  ))
    ;; `(doom-modeline-highlight   ((,class  )))
    ;; `(doom-modeline-panel   ((,class  )))
    ;; `(doom-modeline-host   ((,class  )))
    ;; `(doom-modeline-input-method   ((,class  )))
    ;; `(doom-modeline-input-method-alt   ((,class  )))
    ;; `(doom-modeline-debug   ((,class  )))
    ;; `(doom-modeline-info   ((,class  )))
    ;; `(doom-modeline-warning   ((,class  )))
    ;; `(doom-modeline-urgent   ((,class  )))
    ;; `(doom-modeline-unread-number   ((,class  )))
    ;; `(doom-modeline-bar   ((,class  )))
    ;; `(doom-modeline-bar-inactive   ((,class  )))
    ;; `(doom-modeline-debug-visual   ((,class  )))
    ;; `(doom-modeline-evil-emacs-state   ((,class  )))
    ;; `(doom-modeline-evil-insert-state   ((,class  )))
    ;; `(doom-modeline-evil-motion-state   ((,class  )))
    ;; `(doom-modeline-evil-normal-state   ((,class  )))
    ;; `(doom-modeline-evil-operator-state   ((,class  )))
    ;; `(doom-modeline-evil-visual-state   ((,class  )))
    ;; `(doom-modeline-evil-replace-state   ((,class  )))
    ;; `(doom-modeline-persp-name   ((,class  )))
    ;; `(doom-modeline-persp-buffer-not-in-persp   ((,class  )))
    ;; `(doom-modeline-repl-success   ((,class  )))
    ;; `(doom-modeline-repl-warning   ((,class  )))
    ;; `(doom-modeline-lsp-success   ((,class  )))
    ;; `(doom-modeline-lsp-warning   ((,class  )))
    ;; `(doom-modeline-lsp-error   ((,class  )))
    ;; `(doom-modeline-lsp-running   ((,class  )))
    ;; `(doom-modeline-battery-charging   ((,class  )))
    ;; `(doom-modeline-battery-full   ((,class  )))
    ;; `(doom-modeline-battery-normal   ((,class  )))
    ;; `(doom-modeline-battery-warning   ((,class  )))
    ;; `(doom-modeline-battery-critical   ((,class  )))
    ;; `(doom-modeline-battery-error   ((,class  )))
    ;; `(doom-modeline-buffer-timemachine   ((,class  )))
