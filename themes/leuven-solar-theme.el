...
(let* (
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-highlight ((,class (:foreground "yellow"))))
    ...
    ;;  `(flycheck-error-delimiter ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-delimited-error ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-warning ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-info ((,class (:foreground "red" :background "blue"))))
    `(flycheck-error ((,class (:underline (:style wave :color ,red-d)))))
    `(flycheck-warning ((,class (:underline (:style wave :color ,yellow-d)))))
    `(flycheck-info ((,class (:underline (:style line :color ,green-d)))))


    `(flycheck-fringe-error ((,class (:foreground "white" :background "MediumBlue"))))
    `(flycheck-fringe-warning ((,class (:foreground "white" :background "MediumBlue"))))
    `(flycheck-fringe-info ((,class (:foreground "white" :background "MediumBlue"))))
    ;;  `(flycheck-error-list-error ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-warning ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-info ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-line-number ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-column-number ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-filename ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-id ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-id-with-explainer ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-checker-name ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-error-message ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-error-list-highlight ((,class (:foreground "red" :background "blue"))))
    ;;  `(flycheck-verify-select-checker ((,class (:foreground "red" :background "blue"))))
